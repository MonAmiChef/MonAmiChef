        ...
        <ScrollView showsVerticalScrollIndicator={false} className="flex-1">
          ...
          <Box className="flex gap-4 mb-10">
            <Box>
              ...
              >
                {t('auth.privacy_clauses.clause_1')}
              </Heading>
              <Text className="text-slate-600 leading-6 font-inter-normal">
                {t('auth.privacy_clauses.clause_1_text')}
              </Text>
            </Box>
            ...
            <Box>
              <Heading
                ...
                className="font-inter-semibold text-slate-800 mb-2"
              >
                {t('auth.privacy_clauses.clause_2')}
              </Heading>
              <Text className="text-slate-600 leading-6 font-inter-normal">
                {t('auth.privacy_clauses.clause_2_text')}
              </Text>
            </Box>
            ...
            <Box>
              <Heading
                ...
                className="font-inter-semibold text-slate-800 mb-2"
              >
                {t('auth.privacy_clauses.clause_3')}
              </Heading>
              <Text className="text-slate-600 leading-6 font-inter-normal">
                {t('auth.privacy_clauses.clause_3_text')}
              </Text>
            </Box>
            ...
            <Box>
              <Heading
                ...
                className="font-inter-semibold text-slate-800 mb-2"
              >
                {t('auth.privacy_clauses.clause_4')}
              </Heading>
              <Text className="text-slate-600 leading-6 font-inter-normal">
                {t('auth.privacy_clauses.clause_4_text')}
              </Text>
            </Box>
            ...
            <Box>
              <Heading
                ...
                className="font-inter-semibold text-slate-800 mb-2"
              >
                {t('auth.privacy_clauses.clause_5')}
              </Heading>
              <Text className="text-slate-600 leading-6 font-inter-normal">
                {t('auth.privacy_clauses.clause_5_text')}
              </Text>
            </Box>
          </Box>
        </ScrollView>
